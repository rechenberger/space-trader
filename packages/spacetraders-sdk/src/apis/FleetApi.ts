...
export class FleetApi extends runtime.BaseAPI {
     ...
     * Extract Resources with Survey
     */
    async extractResourcesWithSurvey(requestParameters: ExtractResourcesWithSurveyRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ExtractResources201Response> {
        const response = await this.extractResourcesWithSurveyRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Get Mounts
     */
    async getMounts(requestParameters: GetMountsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetMounts200Response> {
        const response = await this.getMountsRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Install Mount
     */
    async installMount(requestParameters: InstallMountOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<InstallMount201Response> {
        const response = await this.installMountRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Refuel Ship
     */
    async refuelShip(requestParameters: RefuelShipOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RefuelShip200Response> {
     ...
     * Remove Mount
     */
    async removeMount(requestParameters: RemoveMountOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RemoveMount201Response> {
        const response = await this.removeMountRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Ship Refine
     */
    async shipRefine(requestParameters: ShipRefineOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ShipRefine201Response> {
     ...
     * Siphon Resources
     */
    async siphonResources(requestParameters: SiphonResourcesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SiphonResources201Response> {
        const response = await this.siphonResourcesRaw(requestParameters, initOverrides);
        return await response.value();
    }
