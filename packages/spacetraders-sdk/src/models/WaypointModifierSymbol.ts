...
export function WaypointModifierSymbolFromJSON(json: any): WaypointModifierSymbol {
    return WaypointModifierSymbolFromJSONTyped(json, false);
}

export function WaypointModifierSymbolFromJSONTyped(json: any, ignoreDiscriminator: boolean): WaypointModifierSymbol {
    return json as WaypointModifierSymbol;
}

export function WaypointModifierSymbolToJSON(value?: WaypointModifierSymbol | null): any {
    return value as any;
}
