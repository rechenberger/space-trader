...
export function WaypointTraitSymbolFromJSON(json: any): WaypointTraitSymbol {
    return WaypointTraitSymbolFromJSONTyped(json, false);
}

export function WaypointTraitSymbolFromJSONTyped(json: any, ignoreDiscriminator: boolean): WaypointTraitSymbol {
    return json as WaypointTraitSymbol;
}

export function WaypointTraitSymbolToJSON(value?: WaypointTraitSymbol | null): any {
    return value as any;
}
