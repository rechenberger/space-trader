...
export function ContractFromJSONTyped(json: any, ignoreDiscriminator: boolean): Contract {
    ...
    return {
        ...
        'deadlineToAccept': !exists(json, 'deadlineToAccept') ? undefined : (new Date(json['deadlineToAccept'])),
    };
}
...
export function ContractToJSON(value?: Contract | null): any {
    ...
    return {
        ...
        'deadlineToAccept': value.deadlineToAccept === undefined ? undefined : (value.deadlineToAccept.toISOString()),
    };
}
