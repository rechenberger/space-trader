...
export function TradeSymbolFromJSON(json: any): TradeSymbol {
    return TradeSymbolFromJSONTyped(json, false);
}

export function TradeSymbolFromJSONTyped(json: any, ignoreDiscriminator: boolean): TradeSymbol {
    return json as TradeSymbol;
}

export function TradeSymbolToJSON(value?: TradeSymbol | null): any {
    return value as any;
}
